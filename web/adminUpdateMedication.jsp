    ...
    <body>
        ...
        <main>
            ...
            <div style="text-align: left; width: 100%;">
                ...
                <c:if test="${!dataAccess.updateMedConTable(fn:escapeXml(param.medID), fn:escapeXml(param.cond2))}">
                    <c:redirect url="adminEditMedication.jsp?medID=${param.medID}" >
                        <c:param name="errorMessage" value="Could not update secondary condition" />
                    </c:redirect>
                </c:if>
                <c:if test="${!dataAccess.updateMedConTable(fn:escapeXml(param.medID), fn:escapeXml(param.cond3))}">
                    <c:redirect url="adminEditMedication.jsp?medID=${param.medID}" >
